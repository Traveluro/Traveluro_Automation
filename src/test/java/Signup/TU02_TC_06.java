...
{
	logger6=event.createTest("Verify the system behaviour when only the valid first name, last name, email id and password is entered and clicked on Create account button.");
